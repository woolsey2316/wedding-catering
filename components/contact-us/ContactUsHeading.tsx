  ...
  return (
    <div className="bg-gray-100">
      <div className="text-center p-12 pb-20">
        <h1 className="font-parisienne text-h1 font-semibold mb-3">Contact Us</h1>
        <p className="font-rubik max-w-570 mx-auto text-gray-700">Et harum quidem rerum facilis est et expedita distinctio.
        Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil.</p>
      </div>
      <div className="relative w-full transform rotate-180" style={{bottom: '-19px'}} data-negative="false">
