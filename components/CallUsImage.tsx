  ...
  return (
    <div className="bg-platter-tint bg-cover h-screen">
      <div className="w-full bg-transparent" style={{bottom: '-19px'}} data-negative="false">
        <svg className="h-24 w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 100" preserveAspectRatio="none">
      ...
      <div className="grid grid-cols-2">
        <div className="col-start-2 my-auto p-5">
          ...
          <p className="font-rubik text-white mb-16">Et harum quidem rerum facilis est et expedita distinctio. 
