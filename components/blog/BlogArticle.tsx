...
export default function BlogArticle() {
  return (
    <div className="font-rubik text-gray-900 text-sm leading-loose">
      ...
      <blockquote><p className="mb-3 text-gray-600 text-base italic ml-5"><span className="s1">You will never be happy if you continue to search for what happiness consists of. You will never live if you are looking for the meaning of life.</span></p></blockquote>
