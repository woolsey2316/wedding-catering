  ...
  return (
    <div onClick={() => {window.location.href = blog.link}} className="xl:grid grid-cols-12 mt-6 pb-8 border-b border-gray-300">
      ...
      <div className="xl:col-start-7 xl:col-span-6 pl-5">
        ...
        <p className="text-gray-900 font-rubik mt-4 text-sm">Lommodo ligula eget dolor. Aenean massa. Cum sociis que penatibus et magnis dis parturient montes lorem, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla…</p>
      </div>
    </div>
  )
}
