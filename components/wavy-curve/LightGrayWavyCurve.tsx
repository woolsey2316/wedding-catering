...
function LightGrayWavyCurve({yOffset}) {
  return (
    <div className="w-full transform rotate-180 bg-gray-100" style={{bottom: yOffset}} data-negative="false">
...
export default LightGrayWavyCurve;