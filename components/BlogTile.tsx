  ...
  return (
    <>
      <div className="col-span-6">
        <img className="cursor-pointer hover:opacity-85 transition-all duration-500 ease-in-out mb-4" src={props.src}/>
        <a className="block cursor-pointer text-sm text-coral mb-2">{props.category}</a>
        <a className="block cursor-pointer font-nunito font-bold leading-tight text-h4 text-gray-900 hover:text-gray-600 transition-color duration-500 ease-in-out">{props.title}</a>
